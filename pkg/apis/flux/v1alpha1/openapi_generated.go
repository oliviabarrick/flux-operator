...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/justinbarrick/flux-operator/pkg/apis/flux/v1alpha1.Flux": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/justinbarrick/flux-operator/pkg/apis/flux/v1alpha1.FluxSpec"),
							},
						},
						"status": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/justinbarrick/flux-operator/pkg/apis/flux/v1alpha1.FluxStatus"),
							},
						},
					},
			...
			Dependencies: []string{
				"github.com/justinbarrick/flux-operator/pkg/apis/flux/v1alpha1.FluxSpec", "github.com/justinbarrick/flux-operator/pkg/apis/flux/v1alpha1.FluxStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
		},
		"github.com/justinbarrick/flux-operator/pkg/apis/flux/v1alpha1.FluxList": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"kind": {
						...
						"items": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/justinbarrick/flux-operator/pkg/apis/flux/v1alpha1.Flux"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/justinbarrick/flux-operator/pkg/apis/flux/v1alpha1.Flux", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
		},
		"github.com/justinbarrick/flux-operator/pkg/apis/flux/v1alpha1.FluxRole": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "Represents a Role or ClusterRole for the Flux service account user.",
					Properties: map[string]spec.Schema{
						"enabled": {
							SchemaProps: spec.SchemaProps{
								Description: "If enabled, a role will be assigned to the service account (default: false)",
								Type:        []string{"boolean"},
								Format:      "",
							},
						},
						"rules": {
							SchemaProps: spec.SchemaProps{
								Description: "the list of rbac rules to use (default: full access).",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
		...
		"github.com/justinbarrick/flux-operator/pkg/apis/flux/v1alpha1.FluxSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "Settings for operating Flux",
					Properties: map[string]spec.Schema{
						"namespace": {
							SchemaProps: spec.SchemaProps{
								Description: "Namespace to deploy Flux and Tiller into.",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"gitUrl": {
							SchemaProps: spec.SchemaProps{
								Description: "The URL to the Git repository (required).",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						...
						"gitPath": {
							SchemaProps: spec.SchemaProps{
								Description: "The path with in the git repository to look for YAML in (default: `.`)",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"gitPollInterval": {
							SchemaProps: spec.SchemaProps{
								Description: "The frequency with which to fetch the git repository (default: `5m0s`).",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						...
						"fluxImage": {
							SchemaProps: spec.SchemaProps{
								Description: "The image to use for flux (default: `quay.io/weaveworks/flux` or `$FLUX_IMAGE`).",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"fluxVersion": {
							SchemaProps: spec.SchemaProps{
								Description: "The version to use for flux (default: `1.4.0` or `$FLUX_VERSION`).",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						...
						"role": {
							SchemaProps: spec.SchemaProps{
								Description: "A role to add to the service account (default: none)",
								Ref:         ref("github.com/justinbarrick/flux-operator/pkg/apis/flux/v1alpha1.FluxRole"),
							},
						},
						"clusterRole": {
							SchemaProps: spec.SchemaProps{
								Description: "A cluster role to add to the service account (default: none)",
								Ref:         ref("github.com/justinbarrick/flux-operator/pkg/apis/flux/v1alpha1.FluxRole"),
							},
						},
						"tiller": {
							SchemaProps: spec.SchemaProps{
								Description: "The tiller settings.",
		...
		"github.com/justinbarrick/flux-operator/pkg/apis/flux/v1alpha1.Tiller": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "Settings for operating Tiller alongside Flux.",
					Properties: map[string]spec.Schema{
						"enabled": {
							SchemaProps: spec.SchemaProps{
								Description: "Whether or not to deploy a tiller instance in the same namespace (default: false).",
								Type:        []string{"boolean"},
								Format:      "",
							},
						},
						"tillerImage": {
							SchemaProps: spec.SchemaProps{
								Description: "The image to use with tiller (default: `gcr.io/kubernetes-helm/tiller` or `$TILLER_IMAGE`).",
								Type:        []string{"string"},
								Format:      "",
							},
						},
						"tillerVersion": {
							SchemaProps: spec.SchemaProps{
								Description: "The image version to use with tiller (default: `v2.9.1` or `$TILLER_VERSION`).",
								Type:        []string{"string"},
								Format:      "",
							},
						},

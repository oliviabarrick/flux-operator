...
./bin/fluxopctl -flux-operator-version=latest |kubectl apply -f -
...
cr deploy/cr-namespaced.yaml |kubectl delete -f -
./bin/fluxopctl -flux-operator-version=latest |kubectl delete -f -
...
./bin/fluxopctl -flux-operator-version=latest -cluster |kubectl apply -f -
